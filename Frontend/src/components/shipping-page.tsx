  ...
  return (
    <div className=" mt-[122px] sm:mx-[55px] mx-0 ">
      <div className="flex gap-x-[35px] sm:mx-0 mx-5 items-center">
        ...
        <span className="sm:text-2xl text-xl font-Poppins">Shipping Address </span>
      </div>
      <div className="grid sm:grid-cols-2 grid-rows-2 gap-[26px] mt-[34px] mx-2">
        <div className=" sm:p-[45px] p-4   border-2 rounded-lg border-stone-300">
          <div className="flex gap-x-[20px] items-center">
            ...
            <span className="sm:text-2xl text-xl font-Poppins">Add New Address</span>
          </div>
          <div className="grid grid-cols-2 gap-x-[35px]">
            <div className="mt-[31px]">
              <span className="sm:text-lg text-sm font-Poppins">First Name</span>
              <input
                type="text"
          ...
          <div className="flex flex-col mt-[26px]">
            <span className="sm:text-lg text-sm font-Poppins">Street Address</span>
            <input
              type="text"
          ...
          <div className="grid grid-cols-3 gap-x-[15px] mt-[26px]">
            <div className="">
              <span className="sm:text-lg text-sm font-Poppins">Apt Number</span>
              <input
                type="text"
                className="w-full sm:h-[67px] h-[60px] border-2 border-stone-300 rounded-lg px-2 mt-[9px]"
              />
          ...
          <div className="sm:mt-[26px] mt-20 grid grid-cols-[30%_1fr] gap-x-[28px]">
            ...
            <div className=" sm:h-[67px] h-[60px] border-2 border-stone-300 bg-black text-white rounded-lg flex justify-center items-center sm:text-xl text-lg cursor-pointer hover:bg-red-500 transition duration-200">
              Save This Address
            </div>
          </div>
        </div>
        ...
        <div className="border-2 rounded-lg border-stone-300 bg-zinc-100 sm:px-[40px] px-4 pt-[26px] flex flex-col">
          ...
          <div className="sm:text-2xl text-xl font-Poppins  ">Order Summary</div>
          ...
          <div className="flex justify-center items-center">
            <div className=" sm:w-96 w-80 h-[67px] border-2 border-stone-300 bg-black text-white rounded-lg flex justify-center items-center text-xl cursor-pointer hover:bg-red-500 transition duration-200 mt-8">
              Place Order
            </div>
          </div>
        </div>
