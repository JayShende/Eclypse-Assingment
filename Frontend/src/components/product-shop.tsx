    ...
    <div className="w-full  mt-[184px]">
      ...
      <div className="bg-white w-full h-[931px] mt-[183px] grid grid-cols-2">
        ...
        <div className="ml-[32px] mt-[55px] flex flex-col ">
            <span className="text-black font-medium font-Poppins w-[540px]">A tailored composition in motion. Cut from structured wool with a sculpted shoulder and softened hem, this piece captures presence without force. Worn here in the stillness of a city in motion.</span>
            ...
            <div className="mt-[54px]">
                <div className="flex gap-x-[12px] items-center">
                    <span className="text-4xl font-semibold text-neutral-900 font-Poppins">₹ 7,999</span>
                    <span className="text-neutral-500 font-normal font-Poppins">MRP incl. of all taxes</span>
                </div>
                <div className="flex gap-x-[23px] items-center mt-[38px]">
                    <span className="text-neutral-500 text-xl font-medium font-Poppins">Please select a size</span>
                    <span className="text-neutral-500 font-medium font-Poppins underline">Size chart</span>
                </div>
            ...
            <div className="mt-[85px] flex gap-x-[32px]">
                <div className="w-[48] h-16 px-20 py-3.5 rounded-lg outline-2 outline-offset-[-2px] outline-stone-300 flex justify-center items-center">
                    <span className="text-stone-950 text-xl font-medium font-Poppins">Add to Cart</span>
                </div>
                <div className="w-96 h-16 px-36 py-3.5 rounded-lg outline-2 outline-offset-[-2px] outline-stone-300 flex justify-center items-center bg-black hover:bg-red-500 cursor-pointer">
                    <span className="text-white text-xl font-medium font-Poppins">Buy</span>
                </div>
            </div>
        </div>
      </div>
